        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide overlay">
                    <div class="single-slider slide-inner "  style=" background: url({{asset('tohoney_asset/assets/images/slider/1.jpg')}})">
                        <div class="container">
                            <div class="row">
                ...
                <div class="swiper-slide">
                    <div class="slide-inner "  style=" background: url({{asset('tohoney_asset/assets/images/slider/2.jpg')}}">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12 col-lg-9 col-12">
                                    <div class="slider-content">
                ...
                <div class="swiper-slide">
                    <div class="slide-inner "  style=" background: url({{asset('tohoney_asset/assets/images/slider/4.jpg')}}">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12 col-lg-9 col-12">
                                    <div class="slider-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="featured-active2 owl-carousel next-prev-style">
                        @foreach ($category_namee as $category_name)
                        
                        <div class="featured-wrap">
                            <div class="featured-img">
                                  <img src="{{asset('uploads/category_photo')}}/{{$category_name->category_photo}}" alt="not found"> 
                               {{-- <img src="{{base_path('public/uploads/category_photo')}}/{{$category_name->category_photo}}" alt="not found">  --}}
                                <div class="featured-content">
                                    <a href="{{route('categorywise',$category_name->id)}}">{{$category_name->category_name}}</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2>Best Seller</h2>
                        <img src="{{asset('tohoney_asset/assets/images/section-title.png')}}" alt="">
                    </div>
                </div>
            </div>
            <ul class="row">
                ...
                @php
                    $product_dataa=App\Models\product::find($pro->product_id)
                @endphp
                ...
                <div class="col-md-10 offset-md-1 col-12">
                    <div class="testmonial-active owl-carousel">
                        <div class="test-items test-items2">
                            ...
                            <div class="test-img2">
                                <img src="{{asset('tohoney_asset/assets/images/test/1.png')}}" alt="">
                            </div>
                        </div>
                        <div class="test-items test-items2">
                            <div class="test-content">
